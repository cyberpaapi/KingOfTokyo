...
export default function Home() {
  ...
  const playAgain = () => {
    localStorage.removeItem(ROOM_SESSION_KEY); setMode(room ? "multi" : "solo"); setRoom(null); setRoomError(""); setSetupOpen(true);
    revisionRef.current = 0; pendingMutationsRef.current = 0; mutationQueueRef.current = Promise.resolve(); gameRef.current = initialState; rawDispatch({ type: "LOAD", state: initialState });
  };
